...
title: W
# permalink: /w/
# permalink: /w/index.html
permalink: /w.html

layout: page
keywords: sample
summary: "This is the glossary for words that starts with the letter W"
...
## Wav2Vec Model
 ...
 ![]( {{site.toto}}/w/wave2vec_model.webp ){: width="100%"}
...
## Word Embedding Space
 ...
 ![X1]( {{site.company_name}}/w/word_embedding_space.png ){: width="100%"}

 ![X2]( {{site.assets}}/w/word_embedding_space.png ){: width="100%"}

 ![X3]( {{site.toto}}/w/word_embedding_space.png ){: width="100%"}
